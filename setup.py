...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-product_cost_invisible',
    download_url='https://github.com:nantic/trytond-product_cost_invisible.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-product_cost_invisible.git'
    },
    classifiers=[
